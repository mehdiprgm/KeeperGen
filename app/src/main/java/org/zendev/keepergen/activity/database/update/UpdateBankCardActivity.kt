...
import org.zendev.keepergen.databinding.ActivityUpdateBankCardBinding
...
class UpdateBankCardActivity : AppCompatActivity(), View.OnClickListener,
    DatePickerDialog.OnDateSetListener {
    private lateinit var b: ActivityUpdateBankCardBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        b = ActivityUpdateBankCardBinding.inflate(layoutInflater)
    ...
    override fun onClick(view: View?) {
        when (view?.id) {
            ...
            R.id.btnFinish -> {
                if (isFormValid()) {
                    bankCard.cardName = b.txtCardName.text.toString()
                    ...
                    bankCard.year = year.toString()
                    bankCard.month = month.toString()
    ...
    private fun isFormValid(): Boolean {
        ...
        score += validateEditTextData(
            b.txtLayCardName,
            b.txtCardName.text.toString().isEmpty(),
            "Card name is empty."
        )
    ...
    private fun setupFormValidator() {
        b.txtCardName.addTextChangedListener(object : TextWatcher {
            ...
            override fun afterTextChanged(s: Editable?) {
                val databaseBankCard = databaseViewModel.getBankCard(s.toString())

                if (s.toString().isEmpty()) {
                    b.txtLayCardNumber.error = "Name is empty"
                } else {
                    if (databaseBankCard == null) {
                        b.txtLayCardNumber.isErrorEnabled = false
                        b.txtLayCardNumber.error = null

                        b.btnFinish.isEnabled = true
                    } else {
                        if (databaseBankCard.cardName == bankCard.cardName) {
                            b.txtLayCardNumber.isErrorEnabled = false
                            b.txtLayCardNumber.error = null

                            b.btnFinish.isEnabled = true
                        } else {
                            b.txtLayCardNumber.error =
                                "Bank card already exists, select new card name"
    ...
    private fun loadBankCardInformation() {
        ...
        b.txtCardName.setText(bankCard.cardName)
